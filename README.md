...
| --- | --- |
| Public release | `v0.7.1` via [publication/manifest.json](publication/manifest.json) |
...
| Midnight readiness | full universal path for `0.7.1`: status=`ready`, local_operator=`True`, live_submit=`False` via [midnight/readiness.json](midnight/readiness.json) |
| EVM readiness | secondary deploy-capable lane for `0.7.1`: status=`secondary-ready` via [evm/readiness.json](evm/readiness.json) |
...
| Binary integrity | Published release manifest `binary-manifest/v0.7.1/manifest.json` | **SHA-256 verified for `aarch64-apple-darwin`** |
| Midnight operator path | Full universal path for `0.7.1` | **status=ready local_operator=True live_submit=False** |
| EVM operator path | Secondary deploy-capable lane for `0.7.1` | **status=secondary-ready** |
...
| [binary-manifest/v0.7.1/manifest.json](binary-manifest/v0.7.1/manifest.json) | SHA-256 integrity manifest for the published release artifacts |
| [binary-manifest/v0.7.1/installer-manifest.json](binary-manifest/v0.7.1/installer-manifest.json) | Public installer manifest binding the npm wrapper to the attested binary bundle |
