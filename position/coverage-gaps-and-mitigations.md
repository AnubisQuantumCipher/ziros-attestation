...
|---------------|----------------------|-------------------------|
| Logic correctness | 169 mechanized theorem rows, 0 pending, 9 explicit protocol hypotheses disclosed separately | [ledger/verification-ledger.json](../ledger/verification-ledger.json) |
...
| Artifact integrity | SHA-256 manifests and ML-DSA-87 signing policy | [binary-manifest/v0.5.0/manifest.json](../binary-manifest/v0.5.0/manifest.json) |
